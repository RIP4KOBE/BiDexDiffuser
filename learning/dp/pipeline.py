...
class Agent:
    ...
    def get_train_loader(self, batch_size, memmap_loader_path="", eval=False):
        ...
        # <editor-fold desc="Load the training data">
        ...
        # <editor-fold desc="Create the training dataset">
    ...
    def train(
        ...
        # <editor-fold desc="Get the training and evaluation data">
        ...
        # <editor-fold desc="Train the model">
    ...
    def eval(self, data_path, save_path=None):
        # <editor-fold desc="Get the evaluation data">
...
if __name__ == "__main__":
    ...
    args.add_argument("--obs_horizon", type=int, default=1) # The obs_horizon is set to 1 in bidexdiffuser
    # for faster training, which is different from the original DP
    ...
    # <editor-fold desc="Training Agent initialization">
    agent = Agent(
        dropout={
